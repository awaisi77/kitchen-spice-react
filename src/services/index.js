...
export const getCartTotal = cartItems => {
    console.log('cartItems@getCartTotal', cartItems);
    let total = 0;
    for( let i = 0; i < cartItems.length; i ++ ){
        total += parseInt(cartItems[i].qty, 10)*( cartItems[i].discount ? cartItems[i].variations[0].sell_price_inc_tax : cartItems[i].variations[0].sell_price_inc_tax );
    }
    return total;
}
