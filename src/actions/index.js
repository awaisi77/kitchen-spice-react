...
let permissionListUrl = "https://pos.kitchennspicemarket.com/api/v1/pub/product?size=100";
// get all products
export const getAllProducts = () => dispatch => {
    ...
    const payload = {
        ...
        method: 'GET',
        headers: {
            'x-api-key': '49c5343f-341f-438f-aa2e-26417d1fdbf7'
        }
    };
    callApi(payload).then(response => {
        console.log('products:',response)

        dispatch(receiveProducts(response.data.data.content));
        return response.data.data.content;


        // this.dispatch(receiveProducts(response.data.data.content));
