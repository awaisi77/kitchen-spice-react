...
class FooterFour extends Component {
    render() {
        const { logo = "assets/images/demos/demo-22/logo.jpg" } =this.props;
        return (
                        ...
                        <div className="row">
                            <div className="col-sm-12 col-lg-4">
                                <div className="widget widget-about">
                                    <img src={ process.env.PUBLIC_URL + '/' + logo } className="footer-logo" alt="Footer Logo" width="130" height="25"/>
