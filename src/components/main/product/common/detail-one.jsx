                ...
                {0 === product.stock?
                    <div className="product-price">
                        <span className="out-price">
                            ${product.variations[0].sell_price_inc_tax.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) }
                        </span>
                    </div> :

                0 < product.discount? 
                    <div className="product-price">
                        <span className="new-price">${product.variations[0].sell_price_inc_tax.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) }</span>
                        <span className="old-price">${product.variations[0].sell_price_inc_tax.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) }</span>
                    </div> : 
                    <div className="product-price">${product.variations[0].sell_price_inc_tax.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) }</div>
                }
...
*/}
                ...
                <div className="product-details-footer">
                    <div className="product-cat">
                        ...
                        { product.category.name?product.category.name:"NA"}
                    </div>
