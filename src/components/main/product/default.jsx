...
import {addToCart, toggleWishlist, addToCompare, showQuickViewModal, outerLoading, changeDemo} from '../../../actions';
...
*/
                                                    imageSrc={ `https://pos.kitchennspicemarket.com/pos/public/uploads/img/${product.image}` }
                                                    imageAlt="Example"
                                                    largeImageSrc={ `https://pos.kitchennspicemarket.com/pos/public/uploads/img/${product.image}` }
                                                    dragToMove = {false}
                                ...
                                <figure className="product-media">
                                    <Link  to={ `${process.env.PUBLIC_URL}/product/default/27` }>
                                     {/*   <img src={ process.env.PUBLIC_URL + '/' + product.pictures[0] } alt="Product"/>  */}
                                        <img src={ `https://pos.kitchennspicemarket.com/pos/public/uploads/img/${product.image}` } alt="Product"/>
                                    </Link>
                                </figure>
