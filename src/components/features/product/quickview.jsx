                ...
                <div className="quickView-content" >
                    <div className="row">
                                    ...
                                    <OwlCarousel adClass="owl-quickview owl-carousel owl-theme owl-nav-inside owl-light mb-0 owl-loaded owl-drag" carouselOptions="{dots: false,nav:false,dotsContainer: #owl-dots, responsive:{900:{nav:true,dots:true}} " id="owl_quickview">
                                  {
                                        /*productDetail.pictures.map((item, index) =>(*/
                                            ...
                                            {/*    <img src={ process.env.PUBLIC_URL + '/' + item } alt="Desc" />*/}
                                                <img src={ `https://pos.kitchennspicemarket.com/pos/public/uploads/img/${productDetail.image}` } alt="Product"/>
                        ...
                        <div className="col-lg-5 col-md-6">
                            ...
                            <h3 className="product-price">${productDetail.variations[0].sell_price_inc_tax.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) }</h3>
                            ...
                            <div className="product-details-footer">
                                <div className="product-cat">
                                    <span>Category:</span>
                                    <Link to="#"> { productDetail.category.name?productDetail.category.name:"NA"}</Link>
                                </div>
